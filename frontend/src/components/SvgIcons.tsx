...
const Icons = {
  ...
  Gift, Lightbulb, Party,
};

export default Icons;
export { Leaf, Sparkles, Trophy, Shield, Diamond, Medal, Lock, AlertTriangle, CheckCircle, Crown, Ribbon, Seedling, TierSteps, Fire, ShoppingBag, Gift, Lightbulb, Party };
