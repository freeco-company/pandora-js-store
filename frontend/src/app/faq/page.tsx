...
}> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '目前官方站上不提供優惠碼折抵，三階梯定價已是最優惠價格。想獲得更低價格的消費者可以考慮加入「自用加盟」（首次任挑商品滿 NT$6,600 + NT$200 工本費，啟用後長期享加盟成本價）。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          '自用加盟需完成 App 註冊 + 3.5 小時線上課程考核 + 首次任挑商品滿 NT$6,600 購買（加 NT$200 工本費），啟用後長期享加盟成本價，適合每月固定回購、為自己省錢的仙女，沒有業績壓力。創業加盟則提供完整培訓、階梯式獎金、團隊陪伴，適合想將 FP 打造成事業的人。兩者皆不強制分享。',
      },
      {
        question: '創業加盟要如何開始？',
        answer:
