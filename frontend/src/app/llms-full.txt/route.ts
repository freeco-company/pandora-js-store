...
export async function GET() {
  ...
  const lines = [
    ...
    '',
    '**Q：JEROSSE 婕樂纖在哪裡買？**',
    'A：JEROSSE 品牌官網不直接銷售，所有銷售由授權經銷商提供。本站「婕樂纖仙女館」為 JEROSSE 授權正品經銷商。',
    '',
    '**Q：本站定價有什麼特色？**',
    'A：本站採三階梯「自動升級」定價：購物車總數量 ≥ 2 件自動套用搭配價、搭配小計 ≥ NT$4,000 自動升級 VIP 價。系統依購物車內容直接套最優惠階梯，不會因下單方式不同而錯失應得優惠。',
    '',
    '**Q：保健食品可以退貨嗎？**',
